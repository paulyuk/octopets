...
{    // Method previously used to simulate memory exhaustion - now optimized
    private static void AReallyExpensiveOperation()
    {
        // Previously allocated ~1GB of memory causing OutOfMemoryException in production
        // This has been optimized to prevent memory exhaustion
        // Keeping method for backward compatibility but removing memory-intensive operations
    }
